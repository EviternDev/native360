                ...
                <section className="relative pb-32 md:pb-40 pt-16 md:pt-20 px-4 md:px-8 bg-gradient-to-br from-secondary via-secondary/90 to-primary/80 overflow-hidden">
                    ...
                    <div className="relative max-w-4xl mx-auto text-center">
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-5 text-balance leading-tight [text-shadow:0_2px_20px_rgba(0,0,0,0.4)]">
                            About{" "}
                            <span className="text-primary">Native360</span>
                        </h1>
                        ...
                        <p className="text-base md:text-lg text-white/75 max-w-2xl mx-auto text-balance leading-relaxed">
                            Built on trust, accountability, and two decades of
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="max-w-3xl mx-auto text-center mb-16 md:mb-24">
                            <p className="text-xl md:text-2xl text-foreground leading-relaxed font-medium">
                                &ldquo;You&apos;ve likely realized by now that
                                you don&apos;t need more
                                &lsquo;vendors&rsquo;&mdash;you need a reliable
                                partner. Someone you can trust as much as a
                                family member, but hold accountable like a
                                corporate entity. Native 360 was built precisely
                                for this reason. Backed by 20 years of executive
                                corporate leadership and IIM Kozhikode
                                credentials, we bring absolute professional
                                rigor directly to your family&apos;s
                                doorstep.&rdquo;
                            </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center mb-16 md:mb-24">
                            <div>
                                ...
                                <p className="text-foreground/80 text-lg leading-relaxed mb-6">
                                    Native360 was born from a deeply personal
                                    understanding of the challenges NRI families
                                    face. Managing property, caring for ageing
                                    parents, and preserving family traditions
                                    from thousands of miles away is an immense
                                    responsibility.
                                </p>
                                <p className="text-foreground/80 text-lg leading-relaxed">
                                    We are the only Heritage Concierge in Kerala
                                    that manages your entire domestic
                                    ecosystem&mdash;a single, sophisticated
                                    point of contact for everything you hold
                                    dear in the homeland.
                                </p>
                            </div>
